...
its parent variables. Meaning, there is no hidden connection between variables.
Therefore, there are no direct dependencies in the system being modeled other
than those already explicitly shown via edges. This is called \textit{Markov
...
be measured over the same sample space (e.g., existence of multiple sympthoms
for a lung cancer).

Bayesian Networks are often considered to be representations of joint
