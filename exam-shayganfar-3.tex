...
able to operate in ambiguous, uncertain environments, and yet provide the most
acceptable results for us according to the conditions. The reasoning methods
under uncertainty allow AI systems to use uncertain knowledge and make decisions
while minimizing the risk \cite{tanimoto:ai-lisp}.
